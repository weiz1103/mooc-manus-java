...
import io.github.weiz1103.agentflow.springai.domain.port.A2APort;
 ...
 * A2A 工具回调提供者。
 * <p>
 * 。get_remote_agent_cards 。call_remote_agent 两个工具封装。
 * Spring AI {@link ToolCallback}，供 Agent 使用。
 * </p>
 * <p>
 * <b>扩展点：</b> 可在 {@link A2APort} 实现层添。Agent 服务发现、熔断降级等能力。
 * </p>
