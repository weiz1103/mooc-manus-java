package io.github.weiz1103.agentflow.api.infrastructure.external.sandbox;
...
import io.github.weiz1103.agentflow.api.infrastructure.external.browser.SandboxBrowser;
 ...
 * 基于Docker的沙箱服务。
 * <p>
 * Java agentflow-sandbox-server），完成文件、Shell、浏览器等操作。
 * </p>
...
public class DockerSandbox implements Sandbox {
    ...
    @Override
    public String getId() {
        return containerName != null ? containerName : "agentflow-sandbox";
    }
    ...
    public ToolResult<Object> writeShellInput(String sessionId, String inputText, boolean pressEnter) {
        return ToolResult.fail("当前 Java 沙箱服务暂未实现交互。writeShellInput 接口");
    }
