package io.github.weiz1103.agentflow.springai.session;

/**
 * 会话状态加。更新接口。
 *
 * <p>
 * agentflow-spring-ai 模块本身不依。JPA/数据库，通过此接口解耦，
 * 。agentflow-api 提供基于 JPA 的实现。
 * </p>
 *
