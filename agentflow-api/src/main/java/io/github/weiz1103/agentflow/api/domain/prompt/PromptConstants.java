...
/**
 * 提示词系统常量库
 * 迁移。Python 目录：api/app/domain/services/prompts/
 * 统一管理所。Agent 。System Prompt 核心骨架
...
public final class PromptConstants {
    ...
    public static final String REACT_SYSTEM_PROMPT = """
            ...
            # 执行纪律 (严禁违反)
            1. 思考过。(Thought)：你必须先分析当前状态，思考接下来需要做什么。
