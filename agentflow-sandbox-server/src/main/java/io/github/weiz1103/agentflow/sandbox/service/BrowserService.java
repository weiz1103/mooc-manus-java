package io.github.weiz1103.agentflow.sandbox.service;

import com.microsoft.playwright.*;
import com.microsoft.playwright.options.LoadState;
import com.vladsch.flexmark.html2md.converter.FlexmarkHtmlConverter;
import io.github.weiz1103.agentflow.sandbox.constant.BrowserJsConstants;
import io.github.weiz1103.agentflow.common.dto.browser.BrowserDto;
 ...
 * <p>关键设计。
 * <ul>
 *   <li>每个 sessionId 独立拥有一。Page（避免并发干扰）</li>
...
public class BrowserService {
    ...
    public BrowserDto.ViewPageResult viewPage(String sessionId) {
        ...
        List<Map<String, Object>> elements = (List<Map<String, Object>>)
                page.evaluate("() => window.__AgentFlowInteractiveElements || []");
    ...
    public BrowserDto.ActionResult click(String sessionId, int index) {
        ...
        Page page = getOrCreatePage(sessionId);
        try {
            String selector = String.format("[data-AgentFlow-id=\"AgentFlow-element-%d\"]", index);
            page.click(selector);
