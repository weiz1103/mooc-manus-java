package io.github.weiz1103.agentflow.api.infrastructure.client;

import io.github.weiz1103.agentflow.api.domain.exception.SandboxCommunicationException;
import io.github.weiz1103.agentflow.api.infrastructure.config.SandboxProperties;
...
/**
 * 通过 HTTP 调用 agentflow-sandbox-server 的各个接口。
